...
public abstract class AbstractUrlHandlerMapping extends AbstractHandlerMapping implements MatchableHandlerMapping {
    ...
    protected Object getHandlerInternal(HttpServletRequest request) throws Exception {
        ...
        // <2> 获得处理器,详细解析，见 「2.4 lookupHandler」 。
        ...
        if (handler == null) {
            ...
            if (rawHandler != null) {
                ...
                // <3.5> 创建处理器，构建暴露路径的 Handler 。详细解析，见 「2.5 buildPathExposingHandler」 。
    ...
    protected Object lookupHandler(String urlPath, HttpServletRequest request) throws Exception {
        ...
        if (handler != null) {
            ...
            // <1.4> 创建处理器,构建暴露路径的 Handler 。详细解析，见 「2.5 buildPathExposingHandler」 。
     ...
     * for controller to enforce specific preconditions expressed in URL mappings.
     *
    ...
    protected Object buildPathExposingHandler(Object rawHandler, String bestMatchingPattern,
        ...
        // <1> 创建 HandlerExecutionChain 对象,用途在于通过这两个拦截器，暴露 bestMatchingPattern 和 uriTemplateVariables 到请求的属性中。
