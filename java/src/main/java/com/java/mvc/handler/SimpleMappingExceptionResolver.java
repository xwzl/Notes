...
public class SimpleMappingExceptionResolver extends AbstractHandlerExceptionResolver {
	 ...
	 * @param defaultStatusCode the HTTP status code value, for controller 500
	 ...
	 * of the exception (for controller, if multipart resolution failed)
