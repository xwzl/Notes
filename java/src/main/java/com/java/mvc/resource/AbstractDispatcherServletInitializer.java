...
public abstract class AbstractDispatcherServletInitializer extends AbstractContextLoaderInitializer {
    ...
    public void registerDispatcherServlet(ServletContext servletContext) {
        ...
        /**
         * <1> 创建 WebApplicationContext 对象,其实现在{@link AbstractAnnotationConfigDispatcherServletInitializer#createServletApplicationContext}
         */
        WebApplicationContext servletAppContext = createServletApplicationContext();
        Assert.notNull(servletAppContext, "createServletApplicationContext() must not return null");

        // <2> 创建 FrameworkServlet 对象,另外，比较有趣的是传入的 servletAppContext 方法参数，
        // 这就是该 DispatcherServlet 的 Servlet WebApplicationContext 容器啊。
     ...
     * web-related beans.
     * <p>
     * 该方法由子类 AbstractAnnotationConfigDispatcherServletInitializer 重写，并且创建的
     * WebApplicationContext 的子类 AnnotationConfigWebApplicationContext 对象。
     *
     * @see #registerDispatcherServlet(ServletContext)
     */
     ...
     * for controller {@code "/"}, {@code "/app"}, etc.
     *
     * @see #registerDispatcherServlet(ServletContext)
     */
