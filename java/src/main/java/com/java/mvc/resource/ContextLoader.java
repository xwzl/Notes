...
public class ContextLoader {
    ...
    public WebApplicationContext initWebApplicationContext(ServletContext servletContext) {
        ...
        try {
            ...
            // <5> 记录在 servletContext 中，这样，如果 web.xml 如果定义了多个 ContextLoader ，就会在 <1> 处报错。
     ...
     * <ul>
     *     <li>分成两种情况。前者，从 ServletContext 配置的 context 类；后者，从 ContextLoader.properties 配置的 context 类。</li>
     *     <li>默认情况下，我们不会主动在 ServletContext 配置的 context 类，所以基本是使用 ContextLoader.properties 配置的 context 类，即 XmlWebApplicationContext 类。</li>
     * </ul>
     * @param servletContext current servlet context
