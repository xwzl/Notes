...
public class ExceptionHandlerExceptionResolver extends AbstractHandlerMethodExceptionResolver
    ...
    public void afterPropertiesSet() {
        ...
        // 初始化 todo exceptionHandlerAdviceCache、responseBodyAdvice
        initExceptionHandlerAdviceCache();

        // 初始化 todo argumentResolvers 参数
        if (this.argumentResolvers == null) {
            //获得默认的 HandlerMethodArgumentResolver 数组。
            List<HandlerMethodArgumentResolver> resolvers = getDefaultArgumentResolvers();
            this.argumentResolvers = new HandlerMethodArgumentResolverComposite().addResolvers(resolvers);
        }
        // 初始化 todo returnValueHandlers 参数
    ...
    private void initExceptionHandlerAdviceCache() {
        ...
        for (ControllerAdviceBean adviceBean : adviceBeans) {
            ...
            if (resolver.hasExceptionMappings()) {
                //关于 ExceptionHandlerMethodResolver 类，胖友可以先跳到 「7.3 ExceptionHandlerMethodResolver」 小节，看完后回来。
    ...
    protected ModelAndView doResolveHandlerMethodException(HttpServletRequest request,
        ...
        try {
            ...
            if (cause != null) {
                ...
                /**
                 * todo 执行 ServletInvocableHandlerMethod 的调用
                 * {@link com.java.mvc.component.adapter.InvocableMethod}讲过
                 * 比较特别的是，此处传入了 Object... providedArgs 参数为 exception 和 handlerMethod 变量，
                 * 这也是为什么 @ExceptionHanlder 注解的方法，可以设置为这两个参数。
                 */
        ...
        /**
         *  <3.1> 如果 mavContainer 已处理，则返回“空”的 ModelAndView 对象。这样，就不会被后续的 ViewResolver 所处理。
         *  为什么呢？
         *  胖友自己回看下{@link DispatcherServlet#processHandlerException}方法，就很容易明白。
         */
