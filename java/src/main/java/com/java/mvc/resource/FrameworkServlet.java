...
public abstract class FrameworkServlet extends HttpServletBean implements ApplicationContextAware {
     ...
     */
    public Class<?> contextClass = DEFAULT_CONTEXT_CLASS;
    ...
    public final void initServletBean() throws ServletException {
        ...
        try {
            // 初始化 WebApplicationContext 对象,初始化 Servlet WebApplicationContext 对象。============
    ...
    protected void configureAndRefreshWebApplicationContext(ConfigurableWebApplicationContext wac) {
        ...
        /**
         *  <3> 添加监听器 SourceFilteringListener 到 wac 中,触发onRefresh方法,实现 GenericApplicationListener、
         *  SmartApplicationListener 监听器，实现将原始对象触发的事件，转发给指定监听器。
         *  {@link com.java.mvc.resource.SourceFilteringListener}
         *
         ...
         *
         *  {@link ContextRefreshListener()} 执行onRefresh方法刷新配置
         */
    ...
    public void onApplicationEvent(ContextRefreshedEvent event) {
        // <1> 标记 refreshEventReceived 为 true，标记为已经刷新
    ...
    protected void onRefresh(ApplicationContext context) {
        ...
        //This is a empty method and default is DispatcherServlet
        /**
         * 这是一个空方法，具体的实现，在子类 DispatcherServlet 中。
         * {@link DispatcherServlet#onRefresh
         */
    }
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response)
        ...
        // <2.1> 处理 PATCH 请求,为 HttpServlet 默认没提供 #doPatch方法，所以只能通过父类的 #service(...) 方法，从而实现。
