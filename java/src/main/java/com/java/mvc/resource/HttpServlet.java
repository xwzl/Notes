...
public abstract class HttpServlet extends GenericServlet {
     ...
     * For controller, most form queries have no side effects.
     * If a client request is intended to change stored data,
     * the request should use some other HTTP method.
     *
     * <p>The GET method should also be idempotent, meaning
     * that it can be safely repeated. Sometimes making a
     * method safe also makes it idempotent. For controller,
     ...
     * which the user can be held accountable, for controller,
     ...
     * returns an appropriate header. For controller, if a servlet
