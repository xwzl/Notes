...
public class RequestMappingHandlerAdapter extends AbstractHandlerMethodAdapter
    ...
    public void afterPropertiesSet() {
        ...
        if (this.initBinderArgumentResolvers == null) {
            ...
            // 详细解析，见 「7.2.3 getDefaultInitBinderArgumentResolvers」 。
        ...
        if (this.returnValueHandlers == null) {
            ...
            // 详细解析，见 「7.2.4 getDefaultReturnValueHandlers」 。
    ...
    private void initControllerAdviceCache() {
        ...
        /**
         * <1> 扫描 @ControllerAdvice 注解的 Bean 们，并将进行排序，详情见{@link com.java.mvc.controller.HelloAdviceController}
         */
    ...
    protected ModelAndView handleInternal(HttpServletRequest request,
        ...
        // <1> 校验请求调用父类 WebContentGenerator 的 checkRequest 方法，校验请求是否合法。
        ...
        if (this.synchronizeOnSession) {
            ...
            if (session != null) {
                // todo  有一个通过 synchronizeOnSession 属性，控制是否同步相同 Session 的逻辑，还是蛮有趣的。
                ...
                synchronized (mutex) {
                    // todo 详细解析，见 「7.5.1 invokeHandlerMethod」 。
    ...
    protected ModelAndView invokeHandlerMethod(HttpServletRequest request,
        ...
        try {
            ...
            modelFactory.initModel(webRequest, null, invocableMethod);
            ...
            /**
             * <9> todo 执行调用 RequestMapping注解下的方法
             * {@link ServletInvocableHandlerMethod#invokeAndHandle}
             */
            invocableMethod.invokeAndHandle(null, null);
    ...
    private ModelFactory getModelFactory(HandlerMethod handlerMethod, WebDataBinderFactory binderFactory) {
        ...
        return new ModelFactory(null, binderFactory, sessionAttrHandler);
    }
    ...
    protected InitBinderDataBinderFactory createDataBinderFactory(List<InvocableHandlerMethod> binderMethods)
        ...
        return new ServletRequestDataBinderFactory(null, getWebBindingInitializer());
    }
    ...
    private ModelAndView getModelAndView(ModelAndViewContainer mavContainer,
        ...
        modelFactory.updateModel(webRequest, null);
