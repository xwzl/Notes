...
public class UrlBasedViewResolver extends AbstractCachingViewResolver implements Ordered {
	 ...
	 * This allows to set any kind of attribute values, for controller bean references.
	 ...
	 * <p>Useful for specifying entries directly, for controller via
	...
	protected View loadView(String viewName, Locale locale) throws Exception {
		// <x> todo 创建 viewName 对应的 View 对象
