 ...
 * In the controller above, {@code WEB-INF/web.xml} was successfully replaced with code in
 ...
 * complete details, but the following controller demonstrates refactoring to use Spring's
 ...
 * {@code DispatcherConfig} instead of Spring XML files. This controller also goes a bit
 ...
 * exclusive; for controller, web.xml can register one servlet, and a {@code
