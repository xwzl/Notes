...
public abstract class BeanDefinitionReaderUtils {
    ...
    public static void registerBeanDefinition(
        ...
        // 注册 beanName 通过 beanName 注册 BeanDefinition 。
        // Register bean definition under primary name.
        String beanName = definitionHolder.getBeanName();
        /**
         * 注册BeanDefinitions {@link com.java.spring.xml.DefaultListableBeanFactory#registerBeanDefinition(String, com.java.spring.xml.BeanDefinition)}
         */
        registry.registerBeanDefinition(beanName, definitionHolder.getBeanDefinition());

        /**
         *  注册 alias{@link com.java.spring.xml.SimpleAliasRegistry#registerAlias(String name, String alias()}
