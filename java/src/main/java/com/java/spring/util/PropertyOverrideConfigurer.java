...
import com.java.spring.xml.PropertyResourceConfigurer;
 ...
 * the {@code convertPropertyValue} method. For controller, encrypted values
 * can be detected and decrypted accordingly before processing them.
 *
 * @author Juergen Hoeller
 * @author Rod Johnson
 * @see #convertPropertyValue
 * @see com.java.spring.xml.PropertyPlaceholderConfigurer
 * @since 12.03.2003
 */
public class PropertyOverrideConfigurer extends PropertyResourceConfigurer {
    ...
    protected void processKey(ConfigurableListableBeanFactory factory, String key, String value)
        ...
        // 获取分割符 “.” 的索引位置，得到 beanName 以及相应的属性，进行替换========
    ...
    protected void applyPropertyValue(
        ...
        /**
         * 从容器中获取 BeanDefinition ，然后根据属性 property 和其值 value 构造成一个 PropertyValue 对象，最后调用
         * 方法。{@link MutablePropertyValues#addPropertyValue} 是用于保存一组bean属性的信息和值的对像。
         */
