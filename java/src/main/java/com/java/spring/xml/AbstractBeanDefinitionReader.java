...
public abstract class AbstractBeanDefinitionReader implements BeanDefinitionReader, EnvironmentCapable {
	 ...
	 * <p>If the passed-in bean factory does not only implement the BeanDefinitionRegistries
	 * interface but also the ResourceLoader interface, it will be used as default
	 * ResourceLoader as well. This will usually be the case for
	 * {@link org.springframework.context.ApplicationContext} implementations.
	 * <p>If given a plain BeanDefinitionRegistries, the default ResourceLoader will be a
	 ...
	 * <li>最终，都会回归到 XmlBeanDefinitionReader#loadBeanDefinitions(Resource... resources)
	 * 方法，所以这是一个递归的过程。</li>
	 * <li>另外，获得到的 Resource 的对象或数组，都会添加到 actualResources 中。</li>
	 * </ul>
	 * Load bean definitions from the specified xml location.
	 * <p>The location can also be a location pattern, provided that the
	 * ResourceLoader of this bean definition reader is a ResourcePatternResolver.
	 *
	 * @param location        the xml location, to be loaded with the ResourceLoader
