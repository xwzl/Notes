...
class BeanDefinitionValueResolver {
	...
	public Object resolveValueIfNecessary(Object argName, @Nullable Object value) {
		...
		else if (value instanceof com.java.spring.xml.dependcy.NullBean) {
			return null;
		}
		else {
	...
	private Object doEvaluate(@Nullable String value) {
		return this.beanFactory.evaluateBeanDefinitionString(value, (com.java.spring.xml.BeanDefinition) this.beanDefinition);
	}
	...
	private Object resolveInnerBean(Object argName, String innerBeanName, BeanDefinition innerBd) {
		...
		try {
			mbd = this.beanFactory.getMergedBeanDefinition(innerBeanName, null, null);
			...
			Object innerBean = (Object) this.beanFactory.createBean(actualInnerBeanName, mbd, null);
			if (innerBean instanceof FactoryBean) {
				boolean synthetic = mbd.isSynthetic();
				//innerBean = (Object) this.beanFactory.getObjectFromFactoryBean(
				//		(FactoryBean<?>) innerBean, actualInnerBeanName, !synthetic);
			}
			if (innerBean instanceof com.java.spring.xml.dependcy.NullBean) {
				innerBean = null;
			}
			return innerBean;
		}
	...
	private Object resolveReference(Object argName, RuntimeBeanReference ref) {
		try {
			...
			if (bean instanceof com.java.spring.xml.dependcy.NullBean) {
				bean = null;
			}
			return bean;
		}
