...
public abstract class NamespaceHandlerSupport implements NamespaceHandler {
    ...
    public BeanDefinition parse(Element element, ParserContext parserContext) {
        ...
        /**
         *  <1> 获得元素对应的 BeanDefinitionParser 对象获取对应的 BeanDefinitionParser 实例。实际上，其实就是获取在
         *  {@link NamespaceHandlerSupport#registerBeanDefinitionParser(String, BeanDefinitionParser)}方法里面注册的实例对象。
         *
         */
        BeanDefinitionParser parser = findParserForElement(element, parserContext);
        /**
         * <2> 执行解析,返回 BeanDefinitionParser 对象后，调用其 #parse(Element element, ParserContext parserContext) 方法。该方法在
         * AbstractBeanDefinitionParser 中实现，{@link AbstractBeanDefinitionParser#parse(Element, ParserContext)}
         */
     ...
     * name.
     * 注册指定元素的 BeanDefinitionParser 解析器,其实就是将映射关系放在一个 Map 结构的 parsers 对象中。
     * key：元素名
