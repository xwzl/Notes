...
public class XmlValidationModeDetector {
	 ...
	 * <1> 处，调用{@link XmlValidationModeDetector#hasDoctype(String)}方法，判断内容中如果包含有 "DOCTYPE“ ，则为 DTD 验证模式。
	 * <2> 处，调用{@link XmlValidationModeDetector#hasOpeningTag(String)}方法，判断如果这一行包含 < ，并且 < 紧跟着的是字幕，则为 XSD 验证模式。
	 * <3> 处，如果发生 CharConversionException 异常，则为 VALIDATION_AUTO 模式。
	 * 关于{@link XmlValidationModeDetector#consumeCommentTokens(String)}  方法，代码比较复杂。
