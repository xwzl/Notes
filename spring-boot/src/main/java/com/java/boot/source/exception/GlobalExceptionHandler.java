package com.java.boot.source.exception;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
   ...
   /* private static Map<String, Object> cache = new HashMap<>();
    ...
    static {
        cache.put("result", new RestResultVO<ErrorInfo>());
    ...
    protected ResponseEntity<Object> handleExceptionInternal(@NotNull Exception ex, Object body, HttpHeaders headers, HttpStatus status, @NotNull WebRequest request) {
        ...
        RestResultVO<ErrorInfo> resultVO = (RestResultVO<ErrorInfo>) cache.get("result");
